  ...
  return (
    <section className="py-20 bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-20 h-20 bg-gradient-to-br from-primary-400/20 to-secondary-500/20 rounded-full blur-xl"></div>
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-gradient-to-br from-secondary-400/20 to-accent-500/20 rounded-full blur-xl"></div>
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-gradient-to-br from-primary-400/20 to-secondary-500/20 rounded-full blur-lg"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <span className="text-primary-700 font-semibold text-lg">Powerful Features</span>
            <Sparkles className="h-6 w-6 text-primary-400" />
          </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 bg-gradient-to-r from-white/80 to-primary-50/80 backdrop-blur-sm rounded-3xl p-8 border border-primary-200 shadow-xl"
        >
