        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-primary-700">Comprehensive document summary</p>
            </div>
          </div>
          <div className="flex items-center space-x-6 text-sm text-gray-600">
            <div className="flex items-center space-x-2 bg-primary-100 px-3 py-1 rounded-full">
              <Clock className="h-4 w-4 text-primary-600" />
              <span className="text-primary-800 font-medium">AI Generated</span>
            </div>
            <div className="flex items-center space-x-2 bg-secondary-100 px-3 py-1 rounded-full">
              <Scale className="h-4 w-4 text-secondary-600" />
              <span className="text-secondary-800 font-medium">Legal Analysis</span>
            </div>
          </div>
        </div>
        
        <div className="prose prose-lg max-w-none">
          <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl p-6 border-2 border-primary-200 relative overflow-hidden">
            {/* Content Background Pattern */}
            <div className="absolute inset-0 opacity-5">
              <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')]"></div>
            </div>
