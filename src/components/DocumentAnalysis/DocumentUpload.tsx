    ...
    <div className="space-y-6">
        ...
        <div className="relative">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-primary-700">Upload your legal document for AI-powered analysis</p>
            </div>
          </div>
          ...
          <div
            ...
            className={`border-3 border-dashed rounded-2xl p-12 text-center cursor-pointer transition-all duration-300 relative overflow-hidden
              ${isDragActive 
                ? 'border-primary-500 bg-gradient-to-br from-primary-50 to-secondary-50 scale-105 shadow-lg' 
                : 'border-primary-300 hover:border-primary-500 hover:bg-gradient-to-br hover:from-primary-50 hover:to-secondary-50'
              }
          ...
          >
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                >
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-primary-400 to-secondary-500 rounded-full blur-lg opacity-30"></div>
                    <div className="relative bg-gradient-to-r from-primary-500 to-secondary-600 p-6 rounded-full">
                ...
                {isDragActive && (
                  ...
                  >
                    <div className="bg-gradient-to-r from-primary-500 to-secondary-600 p-6 rounded-full shadow-xl">
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="bg-gradient-to-r from-primary-50 to-secondary-50 border-2 border-primary-200 rounded-xl p-4"
          >
            <div className="flex items-center space-x-3">
              <AlertCircle className="h-6 w-6 text-primary-600" />
              <div>
                <p className="font-semibold text-primary-800">Analysis Error</p>
        ...
        {uploadedFile && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="bg-gradient-to-r from-primary-500 to-secondary-600 p-2 rounded-full">
                ...
                <div>
                  <span className="text-primary-800 font-semibold">{uploadedFile.name}</span>
      ...
      >
        <div className="flex items-start space-x-3">
          <Scale className="h-6 w-6 text-primary-600 mt-1" />
          <div>
            <p className="font-semibold text-primary-800 mb-2">Supported Legal Documents</p>
