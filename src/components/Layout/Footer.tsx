...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-primary-900 to-secondary-900 text-white pt-16 pb-8 relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-gradient-to-r from-primary-400 to-secondary-500 p-2 rounded-full">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6 border-b border-primary-700 pb-2 text-primary-200">
              Quick Navigation
            </h3>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
                  <span>{t('nav.home')}</span>
                </Link>
              </li>
              <li>
                <Link to="/chat" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
                  <span>{t('nav.chat')}</span>
                </Link>
              </li>
              <li>
                <Link to="/document-analysis" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
                  <span>{t('nav.documentAnalysis')}</span>
                </Link>
              </li>
              <li>
                <Link to="/downloads" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
                  <span>{t('nav.downloads')}</span>
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-primary-300 transition-colors flex items-center space-x-2">
                  <div className="w-1 h-1 bg-primary-400 rounded-full"></div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <span className="text-primary-300 text-sm">support@kanoon-sarthi.ai</span>
        ...
        <div className="border-t border-primary-800 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              ...
              <span className="text-primary-300 font-medium">Made in India 🇮🇳</span>
            </div>
          </div>
