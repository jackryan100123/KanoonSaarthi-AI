...
const Header: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: t('nav.documentAnalysis'), path: '/document-analysis'},
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-primary-400 to-secondary-500 rounded-full blur-sm opacity-75 group-hover:opacity-100 transition-opacity"></div>
              <div className="relative bg-gradient-to-r from-primary-500 to-secondary-600 p-2 rounded-full">
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/95 backdrop-blur-md border-t border-primary-100 shadow-lg"
          >
